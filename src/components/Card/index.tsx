...
export const Card = ({...props}: CardProps) => {
    return(
        <div {...props} className="w-full">
            <div  className="flex items-center justify-center border-l-2 dark:border-blue-dark-100 w-full h-[200px]">
            ...
            <p className="mt-6 dark:text-blue-dark-100">Tecnologias usadas no projeto</p>
