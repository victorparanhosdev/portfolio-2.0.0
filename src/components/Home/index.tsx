...
export const Home = () => {
    return(
        ...
        <section className="transition-all container-personalizado py-32 w-full">
            ...
            <div className="min-w-[250px] max-w-[420px] h-[420px] sm:max-w-[600px] sm:h-[500px] -mt-16 m-auto md:m-0 flex md:grid justify-center mb-4">
            ...
            <p data-aos="fade-right"  className="dark:text-gray-dark-400 text-4xl md:text-6xl mb-4 font-semibold">Victor Paranhos</p>
