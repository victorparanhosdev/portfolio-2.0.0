...
const tabsStyles = tv({
  base: 'relative md:rounded-r-md md:text-start text-center w-full md:border-l-2 border-b-2 md:border-b-0 border-b-dark-30 md:border-l-dark-30 block py-4 px-4 sm:px-9  data-[state="active"]:bg-dark-20',
