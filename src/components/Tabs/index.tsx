    ...
    <div >
      <Tabs.Content value="stefanini">
        <div className='flex items-center justify-between gap-1 sm:flex-row flex-col'>   
          <h1 className='font-medium text-xl sm:text-2xl dark:text-gray-dark-400'>Desenvolvedor Junior</h1>
          <span className='dark:text-gray-dark-400'>Junho 2024 - Atual</span>
        </div>

        <span className='dark:text-blue-dark-100 block text-md font-medium mt-6 mb-8'>Stefanini</span>
      ...
      <Tabs.Content value="vtrina">
        <div className='flex items-center sm:flex-row flex-col justify-between gap-1'> 
          <h1 className='font-medium text-xl sm:text-2xl dark:text-gray-dark-400'>Estagiário de Suporte Técnico</h1>
          <span className='dark:text-gray-dark-400'>Janeiro 2024 - Junho 2024</span>
        </div>

        <span className='dark:text-blue-dark-100 block text-md font-medium mt-6 mb-8'>Vtrina</span>
      ...
      <Tabs.Content value="dires">
        <div className='flex sm:flex-row flex-col items-center justify-between gap-1'>   <h1 className='font-medium text-xl sm:text-2xl dark:text-gray-dark-400'>Técnico de Informática</h1><span className='dark:text-gray-dark-400'>Maio 2014 - Maio 2024</span></div>

        <span className='dark:text-blue-dark-100 block text-md font-medium mt-6 mb-8'>Dires</span>
