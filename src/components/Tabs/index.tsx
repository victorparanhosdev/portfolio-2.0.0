    ...
    <div >
      <Tabs.Content value="stefanini">
        <div className='flex items-center justify-between gap-1 sm:flex-row flex-col'>   
          <h1 className='font-medium text-xl sm:text-2xl text-white'>Desenvolvedor Junior</h1>
      ...
      <Tabs.Content value="vtrina">
        <div className='flex items-center sm:flex-row flex-col justify-between gap-1'> 
          <h1 className='font-medium text-xl sm:text-2xl text-white'>Estagiário de Suporte Técnico</h1>
      ...
      <Tabs.Content value="dires">
        <div className='flex sm:flex-row flex-col items-center justify-between gap-1'>   <h1 className='font-medium text-xl sm:text-2xl text-white'>Técnico de Informática</h1><span className='text-white'>Maio 2014 - Maio 2024</span></div>
