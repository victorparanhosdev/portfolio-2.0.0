  ...
  return(
    ...
    <div >
      ...
      <Tabs.Content value="dires">
        <div className='flex sm:flex-row flex-col items-center justify-between gap-1'>   <h1 className='font-medium text-xl sm:text-2xl dark:text-gray-dark-400 text-blue-light-100'>Técnico de Informática</h1><span className='dark:text-gray-dark-400 text-blue-light-100'>Maio 2014 - Maio 2024</span></div>
